...
public class AsteroidCreator : MonoBehaviour
{
    ...
    public List<Asteroid> PrepareAsteroids(Transform rotateTarget, float levelPointBudget)
    {
        List<Asteroid> preparedAsteroids = new List<Asteroid>();
        for (int i = 0; i < m_AsteroidsToSpawn+levelPointBudget; i++)//implement a system to change the impact of diffculty level
        {
